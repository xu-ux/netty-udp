 ...
 */
@Slf4j
public class BroadSenderClient implements Runnable{
    ...
    private static class Singleton {
        static final BroadSenderClient instance = new BroadSenderClient();
    }

    public static BroadSenderClient getInstance() {
        return BroadSenderClient.Singleton.instance;
    }

    public BroadSenderClient(){
